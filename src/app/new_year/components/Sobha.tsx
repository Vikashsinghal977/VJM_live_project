...
const Shobha = () => {
    ...
    return (
        <div className="min-h-[400px] bg-[#fdf6e3] p-4 md:p-8 font-['Open_Sans']">
            ...
            <div className="container mx-auto flex flex-col-reverse lg:flex-row gap-8 lg:gap-16 justify-center items-center">
                {/* Video section */}
